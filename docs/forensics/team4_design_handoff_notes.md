...
**future-me 注**：锚均按内容定位、§18.16 干净新节号（原 §18.15→§19 直连无冲突）。三件与 Theory K 件同批 docs commit。#43 corpus C1-C9 增量此前已全 P。#45 余件（①A 缝合/③A 管线退役/⑤A prompt）他方主笔，触及 §5.5 新约束（归属行+150 熔断）时按 ⑥C 审。
