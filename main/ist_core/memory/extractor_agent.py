"""Fork extractor agent：用于在后台执行记忆信息提取的独立子智能体。
...
from main.ist_core.memory.extractor import format_extraction_input
...
def build_extractor_agent(*, backend: Any) -> Any:
    ...
    try:
        model = build_agent_chat_model(model=ist_core_tier_model("haiku"))
