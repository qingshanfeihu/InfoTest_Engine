...
class MemoryWriteMiddleware(AgentMiddleware):
    ...
    def after_model(self, state: Any, runtime: Any) -> dict[str, Any] | None:
        try:
            ...
            try:
                from main.ist_core.memory.extractor import extract_working_entry
    ...
    def _kick_distill_async(self, thread_id: str, messages: list) -> None:
        ...
        if os.environ.get("IST_MEMORY_DISABLE_LLM", "").strip() == "1":
            return
        try:
            from main.ist_core.memory.extractor_agent import run_extractor_async
