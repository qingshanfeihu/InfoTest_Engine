...
参考实现：
- main/ist_core/tools/deepagent/file_tools._resolve_inside_root（三闸 traversal/blacklist/whitelist）
- main/ist_core/middleware/per_turn_skill_reminder._FRONTMATTER_RE（yaml-free 解析）
