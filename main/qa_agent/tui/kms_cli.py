...
def _print_overall_status() -> int:
    from main.qa_agent.tui.kms_command import _format_overall_status
...
def _handle_product(action: str) -> int:
    if action == "status":
        from main.qa_agent.tui.kms_command import _format_product_status
...
def _handle_qa(action: str) -> int:
    if action == "status":
        from main.qa_agent.tui.kms_command import _format_qa_status
...
def _run_product_update() -> int:
    ...
    from main.qa_agent.tui.kms_command import _orgin_buckets
...
def _run_qa_update() -> int:
    ...
    from main.qa_agent.tui.kms_command import _orgin_buckets, _QA_XLSX_EXTS, _QA_MINERU_EXTS
